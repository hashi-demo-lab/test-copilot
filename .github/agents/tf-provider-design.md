...
description: Terraform provider resource design. Produce a single
  provider-design-{resource}.md from clarified requirements and research
  findings. Covers purpose & requirements, schema design, CRUD operations, ...
tools:
  - read
  - edit
  - shell
