...
description: Terraform module test writer. Write module scaffolding
  (versions.tf, variables.tf) and convert design.md test scenarios into
  .tftest.hcl files for TDD workflow. Reads Sections 2, 3, and 5 of the de...
tools:
  - read
  - edit
  - search
